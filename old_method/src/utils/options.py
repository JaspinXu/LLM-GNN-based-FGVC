...
class Options:
    def __init__(self):
        ...
        # Data
        parser.add_argument("--data_root", default="/root/autodl-tmp/fine/Dataset/CUB", help="Root directory for all datasets. Default: ~/Datasets/")
        ...
        parser.add_argument("--crop-mode", default="five_crop",
