...
from cub_dataset_ import ImageFolderDataset
...
class Data:
    ...
    def fgvc(self):
        ...
        path_test_data = os.path.join(path_data, 'val')
        ...
        #trainset = ImageFolderDataset(root_dir=path_train_data,label_file='/root/autodl-tmp/fine/my_method/data/CUB_200_2011/classes.txt',transform=train_transform)
        ...
        #testset = ImageFolderDataset(root_dir=path_test_data,label_file='/root/autodl-tmp/fine/my_method/data/CUB_200_2011/classes.txt',transform=test_transform)
